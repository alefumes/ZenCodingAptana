...
var zen_settings = {
	...
	'css': {
		'snippets': {
			...
			"bc":"background:url(../img/|.jpg) no-repeat;",
			"bd": "border:|;",
			...
			"bgt": "background:url(../img/|.jpg) no-repeat left top;",
	...
	'html': {
		...
		'abbreviations': {
			...
			'form': '<form action="#"><fieldset>|</fieldset></form>',
